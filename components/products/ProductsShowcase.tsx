  ...
  return (
    <section id="projects" className="w-full bg-[#f9f9f9] py-16 lg:py-24">
      <div className="max-w-[1200px] mx-auto px-5 lg:px-8">
        ...
        <h2 className="text-4xl sm:text-6xl font-bold text-slate-950 max-w-4xl mb-16 tracking-tight">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="space-y-4 border-t border-slate-200 pt-6">
                ...
                <div className="border-b border-slate-200/80 pb-4">
                  ...
                  >
                    ...
                    <span className={`material-symbols-outlined text-[#0051d5] transition-transform ${openAccordions[eva.id] === "arch" ? "rotate-180" : ""}`}>
                      expand_more
                    </span>
                  </button>
                  {openAccordions[eva.id] === "arch" && (
                    <div className="mt-3 p-4 bg-white rounded-lg border border-slate-200 text-xs text-slate-700 space-y-2 font-sans shadow-sm animate-[fade-in-up_0.2s_ease-out]">
                ...
                <div className="border-b border-slate-200/80 pb-4">
                  ...
                  >
                    <span>PIPELINE</span>
                    <span className={`material-symbols-outlined text-[#0051d5] transition-transform ${openAccordions[eva.id] === "pipeline" ? "rotate-180" : ""}`}>
                      expand_more
                    </span>
                  </button>
                  {openAccordions[eva.id] === "pipeline" && (
                    <div className="mt-3 p-4 bg-white rounded-lg border border-slate-200 text-xs text-slate-700 font-sans shadow-sm animate-[fade-in-up_0.2s_ease-out]">
                ...
                <div className="border-b border-slate-200/80 pb-4">
                  ...
                  >
                    <span>STACK</span>
                    <span className={`material-symbols-outlined text-[#0051d5] transition-transform ${openAccordions[eva.id] === "stack" ? "rotate-180" : ""}`}>
                      expand_more
                    </span>
                  </button>
                  {openAccordions[eva.id] === "stack" && (
                    <div className="mt-3 flex flex-wrap gap-2 font-mono text-[11px] animate-[fade-in-up_0.2s_ease-out]">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="px-6 py-3 bg-[#0051d5] text-white font-mono text-xs uppercase font-bold tracking-wider hover:bg-[#003ea8] transition-all shadow-md cursor-pointer rounded-sm"
                >
            ...
            {/* Right Column: Hero Image for EVA */}
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            {/* Left Column: Hero Image for Kumbh Bandhu (WITHOUT Live Telemetry Badge) */}
            ...
            <div className="lg:col-span-5 order-1 lg:order-2 space-y-6">
              ...
              <p className="text-slate-600 text-sm sm:text-base leading-relaxed font-sans">
                A massive-scale crowd management system for the world's largest gathering.
              </p>
              ...
              <div className="space-y-4 border-t border-slate-200 pt-6">
                ...
                <div className="border-b border-slate-200/80 pb-4">
                  ...
                  >
                    <span>ARCHITECTURE</span>
                    <span className={`material-symbols-outlined text-[#0051d5] transition-transform ${openAccordions[kumbh.id] === "arch" ? "rotate-180" : ""}`}>
                      expand_more
                    </span>
                  </button>
                  {openAccordions[kumbh.id] === "arch" && (
                    <div className="mt-3 p-4 bg-white rounded-lg border border-slate-200 text-xs text-slate-700 space-y-2 font-sans shadow-sm animate-[fade-in-up_0.2s_ease-out]">
                      <p className="font-medium text-slate-900">On-device 512-dimensional facial embedding vector search (ArcFace TFLite) fused with RFID telemetry signals into a weighted confidence score.</p>
                ...
                <div className="border-b border-slate-200/80 pb-4">
                  ...
                  >
                    <span>PIPELINE</span>
                    <span className={`material-symbols-outlined text-[#0051d5] transition-transform ${openAccordions[kumbh.id] === "pipeline" ? "rotate-180" : ""}`}>
                      expand_more
                    </span>
                  </button>
                  {openAccordions[kumbh.id] === "pipeline" && (
                    <div className="mt-3 p-4 bg-white rounded-lg border border-slate-200 text-xs text-slate-700 font-sans shadow-sm animate-[fade-in-up_0.2s_ease-out]">
                      <p>Sub-second offline biometric candidate ranking, reducing lost pilgrim verification effort by ~73% during mass religious events.</p>
                    </div>
                  )}
                </div>
                ...
                <div className="border-b border-slate-200/80 pb-4">
                  ...
                  >
                    <span>STACK</span>
                    <span className={`material-symbols-outlined text-[#0051d5] transition-transform ${openAccordions[kumbh.id] === "stack" ? "rotate-180" : ""}`}>
                      expand_more
                    </span>
                  </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-white border border-slate-200 rounded-xl p-6 shadow-xl flex flex-col justify-between hover:border-[#0051d5]/50 transition-all group"
          >
            <div>
