        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {capabilities.map((cap, idx) => (
            <motion.div
              ...
              className="skill-card relative bg-[#0a1229] p-7 border border-[#0051d5]/30 rounded-lg group hover:border-[#0051d5] hover:bg-[#0051d5]/10 transition-all duration-300 shadow-xl overflow-visible flex flex-col justify-between"
            >
              <div>
                <div className="w-12 h-12 bg-[#0051d5]/20 rounded flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              ...
              <div>
                <div className="pt-4 border-t border-white/10 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="font-mono text-[10px] uppercase font-bold text-[#0051d5] hover:text-white flex items-center gap-1 cursor-pointer"
                  >
                    <span>Inspect</span>
